...
function MineSummary() {
  ...
  const mines = [
    { id: 1, name: 'ALP Coal Mine, Mancherial, Telangana' },
    { id: 2, name: 'Amalgamated Keshalpur West Mudidih Colliery (AKWMC), Jharkhand' },
    { id: 3, name: 'Bangwar Coal Mine, Shahdol, Madhya Pradesh' },
    { id: 4, name: 'Bansra Coal Mine, West Bengal' },
    { id: 5, name: 'Bhanora Coal Mine (W/B), West Bengal' },
    { id: 6, name: 'Bhubaneswari Coal Mine, Talcher, Odisha' },
    { id: 7, name: 'CHURCHA RO Coal Mine, Korea, Chhattisgarh' },
    { id: 8, name: 'Chora Block Incline, Shankarpur OC, and Bonbahal OC, West Bengal' },
    { id: 9, name: 'Dipka Coal Mine, Korba, Chhattisgarh' },
    { id: 10, name: 'Dudhichua Coal Mine, Singrauli, Madhya Pradesh' },
    { id: 11, name: 'Gevra Open-Cast (OC) Mine, Chhattisgarh' },
    { id: 12, name: 'Godavarikhani-11A Incline Coal Mine, Peddapalli, Telangana' },
    { id: 13, name: 'Haldibari Coal Mine, Korea, Chhattisgarh' },
    { id: 14, name: 'Jayant Coal Mine, Singrauli, Madhya Pradesh' },
    { id: 15, name: 'Jhanjhara Project Colliery, Bilaspur, Chhattisgarh' },
    { id: 16, name: 'Khairaha Coal Mine, Shahdol, Madhya Pradesh' },
    { id: 17, name: 'Kusmunda Coal Mine, Korba, Chhattisgarh' },
    { id: 18, name: 'Kuya/Kocp Coal Mines, Jharkhand' },
    { id: 19, name: 'Lakhanpur Coal Mine, Jharsuguda, Odisha' },
    { id: 20, name: 'Mohar & Moher-Amlori Extension Coal Mine, Singrauli, Madhya Pradesh' },
    { id: 21, name: 'New Godhur Kusunda Colliery, Jharkhand' },
    { id: 22, name: 'Nigahi Coal Mine, Singrauli, Madhya Pradesh' },
    { id: 23, name: 'Phularitand Coal Mines, Jharkhand' },
    { id: 24, name: 'SHARDA HIGHWALL Coal Mine, Shahdol, Madhya Pradesh' },
    { id: 25, name: 'Shyamsunorpur Coal Mine, Paschim Bardhaman, West Bengal' },
    { id: 26, name: 'Tetulmari Coal Mines, West Bengal' },
    { id: 27, name: 'New Akash Kinaree Colliery (NAKC), Eastern India' },
    { id: 28, name: 'GDK 11 Incline, Godavari Valley Coalfield, Telangana' },
