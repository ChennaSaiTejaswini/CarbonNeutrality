  ...
  return (
    <div className="gap-analysis-container">
      ...
      <section className="section">
        ...
        <div className="merged-subsection">
          <h3>Pathways to Neutrality</h3>
          <div className="reduction-scenarios">
            <div className="potential-reduction">
              <h4>Potential Reduction Scenarios</h4>
              <div className="chart-placeholder">Scenario Bar Chart</div>
            </div>

            <div className="scenario-comparison">
              <h4>Scenario Comparison</h4>
              <div className="chart-placeholder">Comparison Line Chart</div>
            </div>
          </div>
        </div>
      </section>
