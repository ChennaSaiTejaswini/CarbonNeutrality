...
function Dashboard() {
    ...
    const totalCarbonEmission = emissionData.reduce((sum, data) => sum + data.fuel_emission + data.electricity_emission, 0) / 1_000_000; // in million tons
    const totalFuelEmission = emissionData.reduce((sum, data) => sum + data.fuel_emission, 0) / 1_000_000; // in million tons
    const totalElectricityEmission = emissionData.reduce((sum, data) => sum + data.electricity_emission, 0) / 1_000_000; // in million tons
    const totalMethaneEmission = emissionData.reduce((sum, data) => sum + data.methane_emission, 0) / 1_000_000; // in million cubic tons
    ...
    // Integrated EmissionLineChart logic
    const [selectedLineChartEmission, setSelectedLineChartEmission] = useState('total emission');

    const lineChartData = Object.entries(predictedYearlyData).map(([year, emissions]) => ({
        year: parseInt(year),
        ...emissions,
    }));
            ...
            <Grid container spacing={3} justifyContent="center" mt={2}>
                <Grid item xs={3}>
                    ...
                    >
                        ...
                        <Typography variant="body2" color="textSecondary">million tons of CO2</Typography> {/* Add unit */}
                    </Paper>
                </Grid>
                ...
                <Grid item xs={3}>
                    ...
                    >
                        ...
                        <Typography variant="body2" color="textSecondary">million tons of CO2</Typography> 
                    </Paper>
                </Grid>
                ...
                <Grid item xs={3}>
                    ...
                    >
                        ...
                        <Typography variant="body2" color="textSecondary">million cubic meters</Typography> 
                    </Paper>
                </Grid>
            </Grid>
      ...
      >
        ...
        <Paper elevation={3} sx={{ 
            ...
            <ResponsiveContainer width="100%" height={300}>
                <BarChart
                    data={lineChartData} // Assuming you have 'lineChartData' prepared
                    margin={{
                        top: 20, 
                        right: 30,
                        left: 20,
